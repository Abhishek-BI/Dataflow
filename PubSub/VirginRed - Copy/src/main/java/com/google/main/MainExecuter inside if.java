...
import org.apache.beam.sdk.options.ValueProvider.Serializer;
...
public class MainExecuter implements Serializable{
	...
	public static void executeWithOptions(String[] option) {
		...
		options.setJobName("FullDataCSV2");
		...
		p //
		 		.apply(PubsubIO.readStrings().fromTopic("projects/virgin-red-test2/topics/emailToUserIdExport")) //
				.apply("window",
				...
				.apply("WordsPerLine", ParDo.of(new DoFn<String, String>() {
					...
					public void processElement(ProcessContext c) throws Exception {
						...
						if (start.equals(s)) {
							...
							PCollection<String> lines = p.apply("Read File",TextIO.read().from(input));
